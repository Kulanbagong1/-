...
echo -e "================== Menu System ======================="
echo -e "*                                                    *"
echo -e "*           Script Created By Abdullah.              *"
echo -e "======================================================"
echo -e "* Saya Membuat Aplikasi PPOB & MMBC Terlengkap Murah *"
echo -e "*      Cari Aja Di Playstore JengkolOnline.          *"
echo -e "======================================================"
echo -e "*     Webset Hosting Murah jengkolonline.biz.id.     *"
echo -e "*.      webset PPOB & MMC jengkolonline.my.id.       *"
echo -e "*               WA = 0823-7213-9631                  *"
echo -e "*                                                    *"
echo -e "=================== Thanks You ======================="
echo -e ""
